      ...
      {(!isMobileView || showMobileMenu) && (
        ...
        >
          ...
          >
            ...
            {!isMobileView && (
              <div style={{ padding: '12px', borderTop: '1px solid #f1f5f9', background: '#1e293b', color: '#94a3b8', fontSize: '9px', fontFamily: 'monospace', height: '250px', marginBottom: '30px', overflowY: 'auto' }}>
